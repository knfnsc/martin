(function () {
    ...
    */
    ...
    const tokenTypes = {
        "scene-heading": /^((?:\*{0,3}_?)?(?:(?:int|ext|est|i\/e)[. ]).+)|^(?:\.(?!\.+))(.+)/i,
        // scene_number: /( *#(.+)# *)/,
    ...
    */
    const fountainLanguage = /*@__PURE__*/StreamLanguage.define({
        name: "fountain",
        startState: () => ({
            inDialogue: false,
        }),
        ...
        tokenTable: {
            "scene-heading": tags.className,
            synopsis: tags.docComment,
            action: tags.lineComment,
            character: tags.propertyName,
            dialogue: tags.string,
            parenthetical: tags.comment,
            centered: tags.heading2,
            page_break: tags.heading2,
            transition: tags.keyword,
        },
    });
    const fountainHighlight = /*@__PURE__*/HighlightStyle.define([
        { tag: tags.lineComment, color: "#444" },
        { tag: tags.docComment, color: "#888" },
        { tag: tags.className, fontWeight: 600 },
        { tag: tags.heading2, fontWeight: 600, display: "block", textAlign: "center" },
        { tag: tags.keyword, fontWeight: 600, display: "block", textAlign: "right" },
        {
            tag: tags.comment,
            fontStyle: "italic",
            display: "block",
        ...
        { tag: tags.string, color: "#252", display: "block", textAlign: "center" },
    ]);
    function fountain() {
